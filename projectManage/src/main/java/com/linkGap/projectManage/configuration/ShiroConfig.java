...
import com.linkGap.projectManage.security.MyShiroRealm;
...
public class ShiroConfig {
 ...
 /*   @Bean
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager){
        ...
        //filterChainDefinitionMap.put("/downloadTemp/**","anon");
        //filterChainDefinitionMap.put("/libs/**","anon");
        //<!-- 过滤链定义，从上向下顺序执行，一般将 /**放在最为下边 -->:这是一个坑呢，一不小心代码就不好使了;
        //<!-- authc:所有url都必须认证通过才可以访问; anon:所有url都都可以匿名访问-->
        //自定义加载权限资源关系
//        List<SysPermission> resourcesList = resourcesService.findAll();
...
//        filterChainDefinitionMap.put("/**", "authc");
    ...
    public DefaultWebSessionManager sessionManager() {
        ...
        //解决there is no session with id问题
        SimpleCookie cookie = new SimpleCookie("sid_projectManage");
